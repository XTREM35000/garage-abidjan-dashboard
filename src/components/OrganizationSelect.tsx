...
const OrganizationSelect: React.FC<OrganizationSelectProps> = ({ onSelect }) => {
  ...
  const fetchOrganizations = async () => {
    try {
      ...
      // Auto-sélectionner s'il n'y a qu'une organisation
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Pour les super admins, pas besoin de code d'accès
    if (isSuperAdmin) {
    ...
    try {
      // Vérifier que le code correspond à l'organisation sélectionnée
      const selectedOrg = organizations.find(org => org.id === selectedOrgId);
      ...
      // Pour les utilisateurs normaux, vérifier le code
